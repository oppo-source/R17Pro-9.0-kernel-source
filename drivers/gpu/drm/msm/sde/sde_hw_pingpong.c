...
#include "sde_kms.h"
#ifdef VENDOR_EDIT
//*Mark.Yao@PSW.MM.Display.LCD.Stability,2018/5/27,add for save display panel power status at oppo display management*/
...
#ifndef VENDOR_EDIT
/*Mark.Yao@PSW.MM.Display.Lcd.Stability,2018/5/26,for solve te sync issue at doze*/
