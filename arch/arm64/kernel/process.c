...
//zhoumingjun.li@Swdp.shanghai, 2017/04/19, add process_event_notifier support
...
//zhoumingjun.li@Swdp.shanghai, 2017/07/06, add process_event_notifier_atomic support
